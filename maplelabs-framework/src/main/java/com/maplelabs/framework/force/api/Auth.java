package com.maplelabs.framework.force.api;
...
import com.maplelabs.framework.force.api.http.Http;
import com.maplelabs.framework.force.api.http.HttpRequest;
        ...
        try {
            ...
            Map<String, Object> resp = jsonMapper.readValue(
                    Http.send(HttpRequest.formPost()
                                    ...
                                    .param("useSecure", "true")
                                    .param("loginType", "3")
                                    .param("grant_type", "password")
                                    .param("portalId", "060600000004ff1")
                                    .param("orgId", "00D1100000088QK")
        ...
        try {
            ...
            byte[] msg = new String(
                    "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n" +
                            ...
                            //      "            <n1:portalId>060600000004ff1</n1:portalId>\n"+
                            //      "            <n1:orgId>00D1100000088QK</n1:orgId>\n"+
