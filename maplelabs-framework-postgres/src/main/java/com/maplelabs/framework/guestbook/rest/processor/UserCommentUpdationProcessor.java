...
@Component("userCommentUpdationProcessor")
public class UserCommentUpdationProcessor extends RestProcessor<String> {
	...
	protected void doProcess() {
        ...
        try {
        	userCommentService.updateUserComment(domain);
